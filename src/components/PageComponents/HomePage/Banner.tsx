  ...
  return (
    <div className="relative">
      ...
      <div className="container mx-auto">
        <div className="absolute top-1/2 left-60 transform -translate-y-1/2 text-white font-sans">
          ...
          <p className="md:mb-4 md:text-2xl font-medium">
            Shop second-hand, save more
          </p>
